...
if __name__ == '__main__':
    ...
    mgr.create_api(models.Point, results_per_page=-1,
                   include_columns=['id', 'amount', 'type', 'why', 'when', 'supervisor', 'student_id'],
                   methods=['GET', 'POST'])
    ...
    mgr.create_api(models.InfractionType, results_per_page=-1, methods=['GET'])
    # username = 'bob'
